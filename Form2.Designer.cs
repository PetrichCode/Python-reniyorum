namespace Python_Öğreniyorum
{
    partial class Form2
    {
        ...
        private void InitializeComponent()
        {
            ...
            label1.Font = new Font("Microsoft Sans Serif", 18F, FontStyle.Bold, GraphicsUnit.Point, 162);
            label1.Location = new Point(12, 60);
            label1.Name = "label1";
            label1.Size = new Size(24, 36);
            label1.TabIndex = 0;
            label1.Text = ".";
            ...
            button2.Location = new Point(199, 197);
